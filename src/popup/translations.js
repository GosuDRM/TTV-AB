...
const TRANSLATIONS = {
	...
	fr: {
		...
		domAdsBlocked: "Annonces DOM bloquées",
	...
	de: {
		...
		achievementsMap: {
			first_block: {
				name: "Werbejäger",
				desc: "Du hast deine erste Werbung blockiert!",
			},
			block_10: { name: "Blocker", desc: "Du hast 10 Werbungen blockiert!" },
			block_100: {
				name: "Wächter",
				desc: "Du hast 100 Werbungen blockiert!",
			},
			block_500: {
				name: "Sentinel",
				desc: "Du hast 500 Werbungen blockiert!",
			},
			block_1000: {
				name: "Legende",
				desc: "Du hast 1000 Werbungen blockiert!",
			},
			block_5000: {
				name: "Mythisch",
				desc: "Du hast 5000 Werbungen blockiert!",
			},
			popup_10: {
				name: "DOM-Reiniger",
			...
			time_1h: {
				name: "Zeitsparer",
				desc: "Du hast 1 Stunde Werbung gespart!",
			},
			time_10h: {
				name: "Zeitmeister",
				desc: "Du hast 10 Stunden Werbung gespart!",
			},
			channels_5: {
				name: "Entdecker",
	...
	zh_CN: {
		...
		achievementsMap: {
			...
			time_1h: { name: "时间节省者", desc: "你已节省 1 小时广告时间！" },
	...
	zh_TW: {
		...
		achievementsMap: {
			...
			time_1h: { name: "時間節省者", desc: "你已節省 1 小時廣告時間！" },
	...
	ru: {
		...
		domAdsBlocked: "Заблокировано DOM-рекламы",
		timeSaved: "Сэкономлено времени",
		statistics: "Статистика",
		last7Days: "Эта неделя",
		...
		achievementsMap: {
			...
			block_5000: {
				name: "Мифический",
				desc: "Вы заблокировали 5000 реклам!",
			},
			popup_10: {
				name: "DOM-очиститель",

...
const TRANSLATIONS = {
	...
	es: {
		...
		logExportReadyText:
			"Guarda el archivo y adjúntalo a tu incidencia de GitHub. No se sube nada automáticamente.",
		...
		logExportSavedText:
			"Adjunta el archivo guardado a tu incidencia de GitHub y luego continúa a GitHub.",
	...
	fr: {
		...
		logExportReadyText:
			"Enregistrez le fichier, puis joignez-le à votre ticket GitHub. Rien n’est envoyé automatiquement.",
		...
		logExportSavedText:
			"Joignez le fichier enregistré à votre ticket GitHub, puis continuez vers GitHub.",
	...
	de: {
		...
		logExportReadyText:
			"Speichere die Datei und hänge sie dann an dein GitHub-Issue an. Es wird nichts automatisch hochgeladen.",
		...
		logExportSavedText:
			"Hänge die gespeicherte Datei an dein GitHub-Issue an und fahre dann auf GitHub fort.",
	...
	pt: {
		...
		logExportReadyText:
			"Salve o arquivo e anexe-o ao seu problema no GitHub. Nada é enviado automaticamente.",
		...
		logExportSavedText:
			"Anexe o arquivo salvo ao seu problema no GitHub e continue no GitHub.",
	...
	it: {
		...
		logExportReadyText:
			"Salva il file, poi allegalo alla segnalazione su GitHub. Nulla viene caricato automaticamente.",
		...
		logExportSavedText:
			"Allega il file salvato alla segnalazione su GitHub, poi continua su GitHub.",
	...
	ja: {
		...
		logExportReadyText:
			"ファイルを保存し、GitHub の Issue に添付してください。自動的にアップロードされることはありません。",
		...
		logExportSavedText:
			"保存したファイルを GitHub の Issue に添付してから、GitHub に進んでください。",
	...
	ko: {
		...
		logExportReadyText:
			"파일을 저장한 다음 GitHub 이슈에 첨부하세요. 자동으로 업로드되지 않습니다.",
		...
		logExportSavedText:
			"저장한 파일을 GitHub 이슈에 첨부한 다음 GitHub로 계속하세요.",
	...
	zh_CN: {
		...
		logExportReadyText:
			"保存文件，然后将其附加到 GitHub Issue。不会自动上传任何内容。",
		...
		logExportSavedText:
			"将已保存的文件附加到 GitHub Issue，然后继续前往 GitHub。",
	...
	zh_TW: {
		...
		logExportReadyText:
			"儲存檔案，然後將其附加到 GitHub Issue。不會自動上傳任何內容。",
		...
		logExportSavedText:
			"將已儲存的檔案附加到 GitHub Issue，然後繼續前往 GitHub。",
	...
	ru: {
		...
		logExportReadyText:
			"Сохраните файл и прикрепите его к задаче на GitHub. Ничего не отправляется автоматически.",
		...
		logExportSavedText:
			"Прикрепите сохранённый файл к задаче на GitHub, затем перейдите на GitHub.",
	...
	uk: {
		...
		logExportReadyText:
			"Збережіть файл і прикріпіть його до завдання на GitHub. Нічого не надсилається автоматично.",
		...
		logExportSavedText:
			"Прикріпіть збережений файл до завдання на GitHub, потім перейдіть на GitHub.",
		logExportOpenIssue: "Перейти на GitHub",

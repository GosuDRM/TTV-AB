...
![Version](https://img.shields.io/badge/version-7.6.9-purple)
...
### v7.6.9
- CSAI poll wait returns cached clean playlist instead of ad-marked content
...
### v7.6.3
- CSAI poll-wait ad-leak closed — ad segments now stripped during background backup search on metadata-marked playlists

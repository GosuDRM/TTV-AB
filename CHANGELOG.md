...
- Fixed the video briefly glitching a few times during longer ad breaks. The extension was switching back and forth between backup streams instead of staying on the one it had already checked, and now it keeps the stream it picked.
